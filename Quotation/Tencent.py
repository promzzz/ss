...
class Tencent(Base):
    """docstring for Tencent"""
    max_num = 800
    Realtime_API = 'http://qt.gtimg.cn/q='
    HistData_API = {'d':'http://data.gtimg.cn/flashdata/hushen/daily/97%s/sz000750%s.js'
                    'w':'http://data.gtimg.cn/flashdata/hushen/weekly/%s.js'
    }
